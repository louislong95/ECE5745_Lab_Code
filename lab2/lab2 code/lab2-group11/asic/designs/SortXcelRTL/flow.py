...
# flow.py
#=========================================================================
# Flow setup for sort accelerator
#
...
def construct():
  ...
  parameters = {
    'design_name'            : 'lab2_xcel_SortXcelRTL',
    ...
    'rtl'                    : 'lab2_xcel_SortXcelRTL.v',
    'vcd'                    : '''
                                 "sort-xcel-rtl-random.vcd"
                                 "sort-xcel-rtl-sorted-fwd.vcd"
                                 "sort-xcel-rtl-sorted-rev.vcd"
                               ''',
